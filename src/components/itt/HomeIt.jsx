        ...
        <section>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 col-sm-12 d-flex justify-content-evenly">
                        <Link to="/it-sem-one" className="btn btn-outline-primary">1st Semester</Link>
                        <Link to="/it-sem-two" className="btn btn-outline-primary">2nd Semester</Link>
                        <Link to="/it-sem-three" className="btn btn-outline-primary">3rd Semester</Link>
                        <Link to="/it-sem-four" className="btn btn-outline-primary">4th Semester</Link>
                    </div>
                    <div className="col-md-3 col-sm-0"></div>
                </div>
                <div className="row mt-4">
                    <div className="col-md-3 col-sm-0"></div>
                    <div className="col-md-6 col-sm-12 d-flex justify-content-evenly">
                        <Link to="/it-sem-five" className="btn btn-outline-primary">5th Semester</Link>
                        <Link to="/it-sem-six" className="btn btn-outline-primary">6th Semester</Link>
                        <Link to="/it-sem-seven" className="btn btn-outline-primary">7th Semester</Link>
                        <Link to="/it-sem-eight" className="btn btn-outline-primary">8th Semester</Link>
                    </div>
                    <div className="col-md-3 col-sm-0"></div>
